...
app.post("/search", function(req,res){
    ...
    else if(input_text.includes("confusion") || input_text.includes("inability to talk") || input_text.includes("noisy breathing") || input_text.includes("loss of consciouness") || input_text.includes("choking") || input_text.includes("food stuck") || input_text.includes("chocked") || input_text.includes("chocke") || input_text.includes("chock")){
    ...
    else if(input_text.includes("burns") || input_text.includes("heat") || input_text.includes("fire") || input_text.includes("flame")|| input_text.includes("burned") || input_text.includes("burn")){
    ...
    else if(input_text.includes("headache") || input_text.includes("head pain") || input_text.includes("exams")|| input_text.includes("head")){
        res.sendFile(__dirname + "/headache.html");
        // console.log("YAah! right");
    }
    else if(input_text.includes("asthma") || input_text.includes("shortness of breath") || input_text.includes(" chest tightness") || input_text.includes(" difficulty breathing")){
        res.sendFile(__dirname + "/asthma.html");
        // console.log("YAah! right");
    }
...
app.get("/brochure",function(req,res){
    res.sendFile(__dirname + "/button3.html");
});
app.post("/brochure", function(req,res){
    res.sendFile(__dirname + "/button3.html")
});
